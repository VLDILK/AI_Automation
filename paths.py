...
# Ротація (2026-08-18): попереднє значення потрапило в публічний git-
# репозиторій (git push --force origin master:main тієї ж сесії) - будь-хто
# міг прочитати його з paths.py на GitHub і слати команди на тунель від
# чужого імені. Стара константа вважається скомпрометованою назавжди,
# замінена новою - після цього оновлення client_app.py на робочому ПК
# ОБОВ'ЯЗКОВО має самооновитись, інакше gui.py й клієнт говоритимуть
# різними ключами і взаємне керування (heartbeat/команди/публікація) не
# працюватиме, доки обидві сторони не отримають цей самий файл.
REMOTE_CONTROL_TOKEN = "2pUnAVJTVdvGzxz6hsJ9jiqXL8IB_MQ5oW3B3u0HHto"
